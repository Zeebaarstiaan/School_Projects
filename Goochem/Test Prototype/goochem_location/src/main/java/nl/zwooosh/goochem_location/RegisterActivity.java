...
public class RegisterActivity extends Activity {
    ...
    private final static String REGISTER_API_ENDPOINT_URL = MainActivity.BASE_URL + "api/v1/registrations";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mPreferences = getSharedPreferences(MainActivity.ID_SETTINGS, MODE_PRIVATE);
    }
        ...
        protected void onPostExecute(JSONObject json) {
            try {
                if (json.getBoolean("success")) {
                    ...
                    editor.putString(MainActivity.ID_AUTH_TOKEN, json.getJSONObject("user").getString("auth_token"));
                    editor.putString(MainActivity.ID_USER_EMAIL, json.getJSONObject("user").getString("email"));
                    editor.commit();
